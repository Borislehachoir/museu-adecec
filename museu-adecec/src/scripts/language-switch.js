const texts = {
    fr: {
        ...
        homeIntro: 'Ceci est un texte. Bienvenue sur un texte, ici on musée le visite.',
        ...
        pfAddress: 'Adresse : 8 rue Philippe Pescetti, 20221 Cervione.',
        pfPhone: 'Téléphone : 04 95 38 12 83.',
        pfText: 'Ajoute ici ensuite les tarifs, l\'accessibilité et les conditions de visite.',

        archTitle: 'Archéologie',
        archDesc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',
        archHeroImgAlt: 'Kayoux de Filitosa :333',
        archMiss: 'Missions',
        archMissTxt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',
        archMissImgAlt: 'gwo trou san fon',
        archHist: 'Histoire',
        archHistTxt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',
        archHistImgAlt: 'j\'ai un petit creus...et pas vous ?',

        roomsBreadcrumb: 'Musée / Les Salles',
        roomsPageTitle: 'Les Salles',
        roomsCardTitle: 'Cathédrale',
        roomsCardDesc: 'Lorem ipsum dolor sit amet...',
        roomsCardBtn: 'Ouvrir',
        ...
        aboutFoundationText: 'Ce bloc accueillera un texte de présentation sur la fondation du musée, son ancrage local et son rôle culturel.',
        aboutMuseum: 'Le musée aujourd’hui',
        aboutMuseumText: 'Ce second bloc servira à présenter l\'évolution du musée, ses missions et l\'expérience proposée au public.',
        ...
        eeTerminalTitle: 'Le Terminal',
        eeTerminalDesc: 'Tapez "<strong>date</strong>" pour afficher la date actuelle...'
    },
    en: {
        navHome: 'Home',
        navRooms: 'Rooms tour',
        ...
        homeIntro: 'This is a text. Welcome to a text, here we museum the visit.',
        ...
        pfAddress: 'Address: 8 rue Philippe Pescetti, 20221 Cervione.',
        pfPhone: 'Phone: 04 95 38 12 83.',
        pfText: 'Add here the prices, accessibility and visiting conditions.',

        archTitle: 'Archaeology',
        archDesc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',
        archHeroImgAlt: 'Kayoux of Filitosa :333',
        archMiss: 'Missions',
        archMissTxt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        archMissImgAlt: 'Deep hole',
        archHist: 'History',
        archHistTxt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        archHistImgAlt: "I've got a small dig... and you don't?",

        roomsBreadcrumb: 'Museum / The rooms',
        roomsPageTitle: 'The rooms',
        roomsCardTitle: 'Cathedral',
        roomsCardDesc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.',
        roomsCardBtn: 'Open',
        roomsImageAlt: 'Cathedral',
        ...
        aboutTitle: 'About',
        aboutFoundation: 'The foundation',
        aboutFoundationText: 'This section will contain a presentation text about the museum foundation, its local roots and its cultural role.',
        aboutMuseum: 'The museum today',
        aboutMuseumText: 'This second section will present the evolution of the museum, its missions and the experience offered to visitors.',
        aboutChurchImgAlt: 'Church',
        aboutMuseumInsideImgAlt: 'Inside the museum',
        aboutMuseumOutsideImgAlt: 'Outside the museum',

        eeTitle: 'You found me?',
        eeDesc: 'Hello there! If you are here, it is either because you got incredibly lucky or because you used your head. Congratulations! <br /> ... <br /> What are you waiting for? There is nothing else to see here. Oh, is it what you see below that intrigues you? There is indeed a small secret. But to discover it, you need to find a word.',
        eeGuess: 'Hints:',
        eeGuess1: 'Nothing is random.',
        eeGuess2: 'Did you read carefully?',
        eeGuess3: 'What day is it? (6 chances out of 7 to be wrong)',
        eeTermTitle: 'The Terminal',
    ...
    co: {
        ...
        navAbout: 'À propositu',

        homeTitle: 'Benvenuti nant\'à u situ di u museu',
        homeIntro: 'Quessu hè un testu. Benvenuti nant\'à un testu, quì si visita u museu.',
        ...
        card2Text: "Esplorà e cullezzione è i cuntenuti ligati à l'archeulugia.",
        ...
        footerAddress: '8 rue Philippe Pescetti, 20221 Cervione',
        footerHours: 'Da luni à sabbatu, 9h–12h, 14h–18h',
        footerPhone: 'Tel. 04 95 38 12 83',
        footerContact: 'Cuntattateci',
        footerPlan: 'Pianu di u situ',
        footerAccess: 'Accessibilità',
        footerLegal: 'Menzione legale',
        footerCredits: 'Crediti',

        pfTitle: 'Preparate a vostra visita',
        pfHours: 'Da luni à sabbatu, 9h–12h è 14h–18h.',
        pfInfo: 'Infurmazione pratiche',
        pfAddress: 'Indirizzu : 8 rue Philippe Pescetti, 20221 Cervione.',
        pfPhone: 'Telefunu : 04 95 38 12 83.',
        pfText: 'Aghjusta quì i tariffi, l\'accessibilità è e cundizione di visita.',
        ...
        archMiss: 'Missione',
        archMissTxt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        archMissImgAlt: 'Gros bucu senza fondu',
        archHist: 'Storia',
        archHistTxt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        archHistImgAlt: "Aghju un picculu scavu... è voi micca?",

        roomsBreadcrumb: 'Museu / E sale',
        roomsPageTitle: 'E sale',
        roomsCardTitle: 'Cattedrale',
        roomsCardDesc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.',
        roomsCardBtn: 'Apre',
        ...
        aboutFoundationText: 'Stu bloccu accuglierà un testu di prisentazione nant’à a fundazione di u museu, u so ancragiu lucale è u so rollu culturale.',
        aboutMuseum: 'U museu oghje',
        aboutMuseumText: 'Stu secondu bloccu serverà à prisentà l\'evoluzione di u museu, e so missione è l\'esperienza pruposta à u publicu.',
        aboutChurchImgAlt: 'Chjesa',
        aboutMuseumInsideImgAlt: 'Internu di u museu',
        aboutMuseumOutsideImgAlt: 'Esternu di u museu',

        eeTitle: "Mi avete truvatu ?",
        eeDesc: 'Bonghjornu ! Sè vo site quì, hè o perchè avete avutu una furtuna incredibile, o perchè avete riflettutu bè. Complimenti ! <br /> ... <br /> Chì aspettate ? Ùn ci hè nunda altru da vede quì. Ah, hè ciò chì vedite quì sottu chì vi incuriosisce ? Hè vera chì ci hè un picculu sicretu. Ma per scoprelu, ci vole à truvà una parolla.',
        eeGuess: 'Indizii :',
...
function injectTexts(lang) {
    ...
    setText('pf-address', t.pfAddress);
    setText('pf-phone', t.pfPhone);
