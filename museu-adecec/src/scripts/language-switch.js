const texts = {
    fr: {
        ...
        infosFaq2Content: ' Nous acceptons uniquement les objets ethnographiques provenant de notre île, principalement du XIXe siècle jusqu\'à la première moitié du XXe siècle. Nous n\'acceptons donc pas les objets qui sortent de ce cadre, comme les amphores romaines ou d\'autres pièces sans trop de rapport avec les missions de notre musée (c\'est fascinant d\'avoir une édition originale du Petit Livre Rouge de Mao Zedong, par exemple, mais notre musée est focalisé sur l\'étude ethnographique et historique du peuple corse). Si vous souhaitez nous donner ou nous confier des objets, merci de nous contacter au 04 95 38 12 83 ou à l’adresse <a href="mailto:secretariat@adecec.net">secretariat@adecec.net</a>.',
        ...
        accessTechText: `HTML, CSS, JavaScript (React, Vite et la bibliothèque PrimeReact). Le menu déroulant de changement de langue est inspiré d'un <a href="https://hohkfuyuhi.github.io/JS-language-changer/" target="_blank" rel="noopener noreferrer">modèle original</a> de Max Ho. Extensions VS Code : indent-rainbow, Image Viewer, HTML CSS Support, Auto Close Tag, Markdown Preview Enhanced. `,
    ...
    en: {
        ...
        accessTechText: `HTML, CSS, JavaScript (React, Vite and the PrimeReact library). The language-switching dropdown menu is inspired by an <a href="https://hohkfuyuhi.github.io/JS-language-changer/" target="_blank" rel="noopener noreferrer">original model</a> by Max Ho. VS Code extensions : indent-rainbow, Image Viewer, HTML CSS Support, Auto Close Tag, Markdown Preview Enhanced. `,
    ...
    co: {
        ...
        accessTechText: `HTML, CSS, JavaScript (React, Vite è a bibliuteca PrimeReact). U menu à tendina di cambiamentu di lingua hè ispiratu da un <a href="https://hohkfuyuhi.github.io/JS-language-changer/" target="_blank" rel="noopener noreferrer">mudellu uriginale</a> di Max Ho. Stinzione VS Code : indent-rainbow, Image Viewer, HTML CSS Support, Auto Close Tag, Markdown Preview Enhanced. `,
